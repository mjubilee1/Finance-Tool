...
const CORE_CONTEXTS = [
  ...
  },
  {
    ...
    content: `Beyond finance, I want a Growth Intelligence layer that continuously answers: what is the highest-leverage thing I can do next to maximize long-term growth? Everything compounds: relationships, skills, reputation, income, investments, businesses, health, knowledge, opportunities, and time. Evaluate decisions by long-term impact, not only immediate reward. Measure growth across career, startup, financial, social, fitness, and personal domains. Optimize for a Compounding Score, not just short-term income. Relationship compounding matters: track follow-ups, fading connections, and who deserves attention. Time allocation: immediate income (Lyft, overtime, contracts) vs long-term leverage (building software, startup work, networking, learning, relationship building, systems). Sometimes skipping one Lyft evening to meet a founder, ship a feature, or strengthen a relationship is the better move — explain opportunity cost. Weekly reviews should ask what worked, what didn't, biggest return, time wasted, what to stop/do more, relationships improved, goals behind, and biggest bottleneck. Daily question: given goals, finances, calendar, relationships, workload, health, and available time — what is the highest-leverage thing I can do today, with why it matters, expected long-term benefit, time required, opportunity cost, related goals/people, and next actions. Think like a high-performing founder: years not days, build leverage, create systems, review evidence, adjust strategy.`
  }
];
